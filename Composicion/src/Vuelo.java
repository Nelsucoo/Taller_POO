public class Vuelo {
    ...
    private Asiento[] asientos; // el cuelo crea y posee sus asientos
    ...
    //Al construir el vuelo con capacidad, se crean automaticamente los asientos
    ...
    public void mostrarAsientos(){
        ...
        // mirar q pasa si el asiento ya esta ocupado en el metodo embarcar

         //Busca un asiento por codigo y lo ocupa
    ...
    public void desembarcar(String codigoAsiento) {
        for (Asiento a: asientos){
            if (a.getCodigo().esquals(codigoAsiento)) {
                a.liberar();
                return;
            }
        }
